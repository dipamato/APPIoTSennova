...
namespace Presentacion.Pages
{
    public class DatosModel : PageModel
    {
        ...
        public DatosModel(IRepositorio repo)
        {
            _repo = repo;
        }
        [BindProperty]
        public IEnumerable<Voltaje> listVoltajes { get; set; }
        ...
        {
            listVoltajes = new List<Voltaje>();
            listVoltajes = _repo.GetAllVoltajes();
        ...
        public async Task<IActionResult> OnPostDos()
        {
            ...
            Console.WriteLine("list: " + Resultado1);
            return RedirectToPage("/Vistas/Datos", "Resultado", new { Resultado1 });
